...
const texto = `Desde o início como desenvolvedor, sou movido pela curiosidade e 
vontade de transformar ideias em soluções reais. Meu GitHub reflete essa jornada com projetos práticos e focados em evolução contínua.`;
...
export default function EmDesenvolvimento() {
  ...
  useEffect(() => {
    ...
    const palavras = linhas[linhaAtual].split(' ').filter(Boolean);
    let index = 0;
